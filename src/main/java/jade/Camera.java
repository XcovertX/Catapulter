...
public class Camera {
    ...
    private Vector2f projectionSize = new Vector2f(32.0f * 80.0f, 32.0f * 42.0f);
    ...
    public Matrix4f getViewMatrix() {
        ...
        viewMatrix.lookAt( new Vector3f( position.x, position.y,20.0f ),    // Direction to look
                          cameraFront.add( position.x, position.y, 0.0f ),  // Where the camera front is
